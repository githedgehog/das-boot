...
if [ -f ${IMAGE_DIR}/agent ]; then
    ...
    $ORAS pull -o ${IMAGE_DIR} ghcr.io/githedgehog/fabric/agent:v0.13.0
fi
echo
...
( cd $IMAGE_DIR && $HELM pull --version=v0.13.0 oci://ghcr.io/githedgehog/fabric/charts/fabric-api )
( cd $IMAGE_DIR && $HELM push fabric-api-v0.13.0.tgz oci://registry.local:5000/githedgehog/helm-charts )
